    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/refresh", "/api/auth/logout", "/api/auth/validate-session", "/api/auth/user").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/clothing-items/filter").authenticated()
                        .requestMatchers("/api/notifications/unread", "/api/notifications/mark-as-read").authenticated()
